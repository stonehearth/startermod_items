...
echo Platform is $RADIANT_BUILD_PLATFORM
../../build/$RADIANT_BUILD_PLATFORM/source/stonehearth/RelWithDebInfo/Stonehearth.exe --game.main_mod=stonehearth_autotest --simulation.game_speed=10&
stonehearth_pid=$!
