...
luabind::scope VoronoiMapSite::RegisterLuaType(struct lua_State* L, const char* name)
{
   using namespace luabind;
   return
      class_<VoronoiMapSite, std::shared_ptr<VoronoiMapSite>>(name)
...
luabind::scope VoronoiMap::RegisterLuaType(struct lua_State* L, const char* name)
{
   using namespace luabind;
   return
      class_<VoronoiMap, std::shared_ptr<VoronoiMap>>(name)
      .def(tostring(const_self))
