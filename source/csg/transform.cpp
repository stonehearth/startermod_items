...
csg::Transform csg::Transform::zero(Point3f(0.0, 0.0, 0.0), Quaternion(0.0, 0.0, 0.0, 1.0));

csg::Transform csg::Interpolate(const csg::Transform &t0, const csg::Transform &t1, double alpha)
{
   csg::Transform t;
