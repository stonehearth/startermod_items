...
function CarpenterTest:__init()
   ...
   self:place_item('stonehearth:furniture:arch_backed_chair', 0, 0)
   self:place_item('stonehearth:furniture:comfy_bed', 1, 0)
   self:place_item('stonehearth:furniture:dining_table', 2, 0)
   self:place_item('stonehearth:furniture:picket_fence', 0, 1)
   self:place_item('stonehearth:furniture:picket_fence_gate', 1, 1)
   self:place_item('stonehearth:furniture:simple_wooden_chair', 2, 1)
   self:place_item('stonehearth:furniture:table_for_one', 3, 1)
   self:place_item('stonehearth:portals:wooden_door', 4, 1)
   self:place_item('stonehearth:portals:wooden_window_frame', 0, 2)
   self:place_item('stonehearth:furniture:picket_fence', 0, 3)
   self:place_item('stonehearth:furniture:picket_fence', 1, 3)
   ...
   self:place_item('stonehearth:decoration:firepit', 7, 3, player_id)
   self:place_item('stonehearth:decoration:firepit', 9, 3, player_id)
