...
function PatrolTest:__init()
   ...
   local footmen = {
      self:place_citizen(15, 15, 'footman', 'stonehearth:weapons:wooden_sword'),
      self:place_citizen(14, 14, 'footman', 'stonehearth:weapons:wooden_sword'),
      --self:place_citizen(13, 13, 'footman', 'stonehearth:weapons:wooden_sword'),
      --self:place_citizen(12, 12, 'footman', 'stonehearth:weapons:wooden_sword'),
   }
...
function PatrolTest:equip_all(entities)
   for _, entity in pairs(entities) do
      self:equip_weapon(entity, 'stonehearth:weapons:wooden_sword')
   end
end
