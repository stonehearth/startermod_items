...
function TrappingService:create_trapping_grounds(player_id, location, size)
   local entity = radiant.entities.create_entity('stonehearth:trapper:trapping_grounds', { owner = player_id })
