...
--
function DemandTribute:_update_bulletin(new_bulletin_data)
	local ctx = self._sv.ctx
	...
	local bulletin_data = self._sv.bulletin_data
	bulletin_data.title = new_bulletin_data.title
	bulletin_data.message = new_bulletin_data.message
	bulletin_data.ok_callback = new_bulletin_data.ok_callback
	bulletin_data.next_callback = new_bulletin_data.next_callback
	bulletin_data.accepted_callback = new_bulletin_data.accepted_callback
	bulletin_data.declined_callback = new_bulletin_data.declined_callback
	self.__saved_variables:mark_changed()
