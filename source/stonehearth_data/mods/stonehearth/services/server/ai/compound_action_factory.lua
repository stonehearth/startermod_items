...
function CompoundActionFactory:create_action(entity)
   return CompoundAction(entity, self._base_action, self._activity_sequence, self._think_output_placeholders)
end
