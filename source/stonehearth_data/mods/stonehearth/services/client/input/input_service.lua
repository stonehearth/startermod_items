...
function InputService:capture_input_for_ui(session, response, captured)
   self._ui_has_capture = captured
end

function InputService:ui_has_capture(session, response, captured)
   return self._ui_has_capture
end
