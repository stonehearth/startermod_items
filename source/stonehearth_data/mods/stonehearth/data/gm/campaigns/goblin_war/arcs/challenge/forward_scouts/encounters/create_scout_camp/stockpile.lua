...
function Stockpile:start(ctx, info)
   ...
   assert(info.encounter_name and info.entity_name, "missing encounter info") 
   local ctx_encounter = ctx[info.encounter_name] 
   ...
   ctx_encounter.entities.entity_name = stockpile
end
