...
local RunInCircles = class()

RunInCircles.name = 'run in circles'
RunInCircles.does = 'stonehearth:pet:play'
RunInCircles.args = {}
RunInCircles.version = 2
RunInCircles.priority = 1
RunInCircles.weight = 1
...
function RunInCircles:__init()
   self._random_circle_probability = 0.50
   self._circle_size = 3
   self._num_circles = 3
end

function RunInCircles:run(ai, entity, args)
