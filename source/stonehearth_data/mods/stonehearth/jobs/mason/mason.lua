...
function MasonClass:initialize(entity)
   job_helper.initialize(self._sv, entity)
   self:restore()
end

function MasonClass:restore()
...
function MasonClass:associate_entities_to_talisman(talisman_entity)
...
function MasonClass:_on_craft(args)
