...
function BlacksmithClass:initialize(entity)
   job_helper.initialize(self._sv, entity)
   self:restore()
end

function BlacksmithClass:restore()
...
function BlacksmithClass:promote(json, talisman_entity)
...
function BlacksmithClass:get_worker_defense_participation()
   return self._sv.worker_defense_participant
end

-- Call when it's time to level up in this class
function BlacksmithClass:level_up()
...
function BlacksmithClass:associate_entities_to_talisman(talisman_entity)
...
function BlacksmithClass:demote()
...
function BlacksmithClass:_on_craft(args)
