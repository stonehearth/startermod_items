...
function CookClass:initialize(entity)
   job_helper.initialize(self._sv, entity)
   self:restore()
end

function CookClass:restore()
...
function CookClass:promote(json, options)
...
function CookClass:_on_craft(args)
