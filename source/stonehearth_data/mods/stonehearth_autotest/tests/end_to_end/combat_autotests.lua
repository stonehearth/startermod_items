...
function combat_tests.battle_royale(autotest)
   local footmen = {
      ...
      autotest.env:create_person( -7, -15, { profession = 'footman' }),
      autotest.env:create_person(  1, -15, { profession = 'footman' }),
      autotest.env:create_person(  9, -15, { profession = 'footman' }),
   }
...
function combat_tests.patrol(autotest)
   ...
   local footman = autotest.env:create_person(5, 5, { profession = 'footman' })
