...
function carpenter_class.promote(entity, promotion_data)
   -- xxx: bad!  gotta get rid of inject (tony)
    radiant.entities.xxx_inject_into_entity(entity, 'stonehearth.mixins.carpenter_job')
   ...
   local outfit = radiant.entities.create_entity('stonehearth.carpenter_outfit')
