...
ai_mgr:register_action('radiant.actions.goto_entity', GotoEntity)

function GotoEntity:run(ai, entity, target, travel_mode, close_to_distance)
   ...
   self._mover = native:create_goto_entity(entity, mi.speed, target, close_to_distance)
...
function GotoEntity:stop(ai, entity, path)
