...
class Pipeline : public core::Singleton<Pipeline> {
   public:
      ...
      H3DNodeUnique CreateSelectionNode(H3DNode parent, csg::Region2 const& model, csg::Color4 const& interior_color, csg::Color4 const& border_color);
   ...
   private:
      ...
      H3DNodeUnique CreateXZBoxNode(H3DNode parent, csg::Region2 const& model, csg::Color4 const& interior_color, csg::Color4 const& border_color, double border_size);
