...
void Room::StartProject(const dm::CloneMapping& mapping, std::function<void(BuildOrderPtr)> regcb)
{
   ...
   for (int i = 0; i < 4; i++) {
      ...
      EntityPtr e = Stonehearth::CreateEntityLegacyDIEDIEDIE(GetStore(), "/stonehearth/buildings/scaffolding");
...
{
   om::EntityPtr entity = Stonehearth::CreateEntityLegacyDIEDIEDIE(GetStore(), "/stonehearth/buildings/floor");
...
{
   om::EntityPtr entity = Stonehearth::CreateEntityLegacyDIEDIEDIE(GetStore(), "/stonehearth/buildings/roof");
