...
TiledRegion::TiledRegion(TileMap3& tiles, csg::Point3 tile_size, dm::Store& store)
{
   Initialize(tiles, tile_size, store);
}

void TiledRegion::Initialize(TileMap3& tiles, csg::Point3 tile_size, dm::Store& store)
{
   _tiles = &tiles;
