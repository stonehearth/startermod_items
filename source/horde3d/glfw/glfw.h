...
typedef void (GLFWCALL * GLFWrawinputfun)(UINT msg, WPARAM wparm, LPARAM lparam);
...
GLFWAPI void* GLFWAPIENTRY glfwGetWindowHandle( );
GLFWAPI void GLFWAPIENTRY glfwSetRawInputCallback( GLFWrawinputfun cbfun );
