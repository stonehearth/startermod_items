...
private:
   ...
   bool loadXMLPipeline(XMLNode const& rootNode);
   bool loadLuaPipeline(std::string const& filename);
   bool setupPipeline(std::string const& xml);
   PipelineStagePtr compileStage(std::string const& xml);
