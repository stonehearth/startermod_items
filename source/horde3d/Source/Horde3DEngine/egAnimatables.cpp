...
SceneNodeTpl *MeshNode::parsingFunc( map< string, std::string > &attribs )
{
	bool result = true;
...
bool MeshNode::checkIntersection( const Vec3f &rayOrig, const Vec3f &rayDir, Vec3f &intsPos, Vec3f &intsNorm ) const
{
...
SceneNodeTpl *JointNode::parsingFunc( map< string, std::string > &attribs )
{
	bool result = true;
