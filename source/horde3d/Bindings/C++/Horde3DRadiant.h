...
#include "../extensions/stockpile/terrain_node.h"
...
::radiant::horde3d::TerrainNode* h3dRadiantCreateTerrainNode(H3DNode parent, std::string name, int type, ::radiant::csg::mesh_tools::mesh const& m);
