...
#define DLL extern "C"  // statically link...
...
/* Function: h3dGetVersionString
	...
	Details:
		This function returns a pointer to a std::string containing the current version of Horde3D.
...
/* Function: h3dGetResName
	...
	Returns:
		name of the resource or empty std::string in case of failure
*/
...
/* Function: h3dCloneResource
	...
	Details:
		...
		returns 0. If the name std::string is empty, a unique name for the resource is generated automatically.
...
/* Function: h3dFindResElem
	...
	Details:
		...
		std::string comparisons done for the search are case-sensitive.
...
/* Function: h3dGetResParamStr
		Gets a std::string property of a resource element.
	
	Details:
		This function returns a specified property of the specified resource element.
		The property must be of the type std::string (const char *).
	...
	Returns:
		value of the property or empty std::string if no such property exists
*/
DLL const char *h3dGetResParamStr( H3DRes res, int elem, int elemIdx, int param );

/* Function: h3dSetResParamStr
		Sets a std::string property of a resource element.
	
	Details:
		This function sets a specified property of the specified resource element to the
		specified value. The property must be of the type std::string (const char *).
...
DLL bool h3dGetTextureData( H3DRes texRes, int *width, int *height, int *compCount, void *dataBuffer, int bufferSize );
...
/* Function: h3dSetNodeTransform
	...
	Returns:
		nothing
*/
DLL bool h3dSetNodeTransform( H3DNode node, float tx, float ty, float tz,
                              float rx, float ry, float rz, float sx, float sy, float sz );
...
/* Function: h3dFindNodes
	...
	Parameters:
		...
		name       - name of nodes to be searched (empty std::string for all nodes)
...
/* Function: h3dSetModelMorpher
	...
	Details:
		...
		is an empty std::string the weight of all morph targets in the specified Model node is modified.
