...
void store::push_category(const std::string& category)
{
...
store::profile_entry *store::profile_entry::get_child(const std::string& subcat) {
...
void store::profile_entry::dump_stats(const std::string& parent_category, metrics::time parent_duration, metrics::time overall_duration)
{
